...
В репозитории — бэкенд и Telegram-бот. Отдельный фронтенд (WebApp) должен быть развёрнут отдельно и доступен по `FRONT_URL`; исходники фронта могут находиться в другом репозитории — уточняйте по документации на [Holst](https://app.holst.so/share/b/e9f74409-db54-4fca-b19b-796eff42a3ad).
