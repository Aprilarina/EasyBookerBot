...
Если требуется презентация-питч для инвестора (IR Presentation) - обращайтесь @atitarenko (TG), поделюсь своим примером.

Подписывайтесь на мой канал @yestartup (TG) - там тоже много полезного.
