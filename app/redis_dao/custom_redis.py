...
class CustomRedis(Redis):
    ...
    async def get_cached_data(self, cache_key: str, fetch_data_func: Callable[..., Awaitable[Any]],
                              *args, ttl: int = 1800, **kwargs) -> Any:
        """
        ...
        if cached_data:
            ...
            await self.setex(cache_key, ttl, json.dumps(data))
